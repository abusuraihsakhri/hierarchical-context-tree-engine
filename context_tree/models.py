"""
Data Models & Telemetry Definitions for HierarchicalContext-Tree: Multi-Tier Token Buffer & Recency Pyramid Engine.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Hierarchical Context Management Protocol"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
