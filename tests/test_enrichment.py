"""
Automated Pytest for hierarchical-context-tree-engine Enrichment Modules.
"""
import sys
...
from enrichment import (
    TreePruningStrategiesEngine,
    SubtreeCachingEngine,
    TreeDiffVisualizationEngine,
    ParallelBranchResolutionEngine,
    TreeDepthLimitingEngine,
    HierarchicalcontexttreeengineEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = HierarchicalcontexttreeengineEnrichmentSuite()
