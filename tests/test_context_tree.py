...
import pytest
from context_tree.models import FrontierPayload, ExecutionStatus
from context_tree.engine import FrontierDomainEngine
from context_tree.agents import BranchSummarizerAgent, RecencyDecayPrunerAgent, EpisodicMemoryIndexerAgent, ContextTreeCoordinator
from context_tree.cli import main


def test_sub_agents():
    a1 = BranchSummarizerAgent()
...
def test_coordinator():
    ...
    assert "Hierarchical Context Management Protocol" in ans or "specifications" in ans
